...
class TopRatingViewModel @ViewModelInject constructor(
    ...
    private val _TopRatingMovies= MutableLiveData<PagingData<Movie>>()
    val TopRatingMovies: LiveData<PagingData<Movie>>
