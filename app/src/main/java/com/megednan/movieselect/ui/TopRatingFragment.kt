...
import com.megednan.movieselect.databinding.TopRatingFragmentBinding
import com.megednan.movieselect.viewmodels.TopRatingViewModel
import dagger.hilt.android.AndroidEntryPoint
import kotlinx.android.synthetic.main.error_layout.*
import kotlinx.android.synthetic.main.popular_movies_fragment.*

@AndroidEntryPoint
class TopRatingFragment : Fragment(R.layout.top_rating_fragment) {
    private val viewModel by viewModels<TopRatingViewModel>()
    lateinit var adapter: MoviePagingAdapter
    lateinit var binding: TopRatingFragmentBinding
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter.setOnItemClickListener {
            ...
            findNavController().navigate(
                    R.id.action_topRatingFragment_to_moviesDetailsFragment,
                    bundle
            )
        }
        val gridLayoutManager = GridLayoutManager(this.context, 3)
        binding = TopRatingFragmentBinding.bind(view)
    ...
    override fun onActivityCreated(savedInstanceState: Bundle?) {
        ...
        viewModel.TopRatingMovies.observe(viewLifecycleOwner, Observer {
